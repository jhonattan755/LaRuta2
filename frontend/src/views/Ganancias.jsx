...
function Ganancias() {
  ...
  const [rates, setRates] = useState([
    ...
    { id: 2, dept: "La Libertad", difficulty: "Media (Costa)", color: "bg-cyan-50 text-cyan-600 border-cyan-200", multiplier: "1.15x", surcharges: "Ajuste Combustible (+2%)" },
    { id: 3, dept: "Santa Ana", difficulty: "Media (Altiplano)", color: "bg-indigo-50 text-indigo-600 border-indigo-200", multiplier: "1.10x", surcharges: "Ninguno" },
    { id: 4, dept: "Chalatenango", difficulty: "Alta (Montaña)", color: "bg-orange-50 text-orange-600 border-orange-200", multiplier: "1.45x", surcharges: "Recargo por Distancia" },
    { id: 5, dept: "San Miguel", difficulty: "Media (Oriente)", color: "bg-purple-50 text-purple-600 border-purple-200", multiplier: "1.25x", surcharges: "Impuesto Regional" },
  ]);

  const shipments = [
    { id: "SV-9921-X9", status: "En Tránsito", statusColor: "bg-emerald-100 text-emerald-700", eta: "14:30 · San Salvador", progress: "w-3/4 bg-blue-600" },
    { id: "SV-8842-P2", status: "Recolecta", statusColor: "bg-orange-100 text-orange-700", eta: "Esperando Mensajero · Santa Tecla", progress: "w-1/4 bg-orange-500" },
    { id: "SV-7712-L1", status: "Retrasado", statusColor: "bg-rose-100 text-rose-700", eta: "Alerta Climática · La Unión", progress: "w-1/2 bg-rose-500" },
      ...
      <main className="flex-1 flex flex-col min-w-0">
        ...
        <header className="bg-white border-b border-slate-200 h-16 px-8 flex items-center justify-between gap-4 sticky top-0 z-10">
          <div className="relative w-full max-w-md">
            ...
            <input 
              type="text" 
              placeholder="Buscar ID de envío o guía..." 
              value={searchTerm}
        ...
        <div className="p-8 space-y-8 flex-1 overflow-y-auto max-w-7xl w-full mx-auto">
          ...
          <div>
            <h1 className="text-2xl font-black text-slate-900 tracking-tight">Panel de Control - LA RUTA</h1>
            <p className="text-xs font-semibold text-slate-500 mt-0.5">Métricas de distribución en tiempo real de El Salvador</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex flex-col justify-between">
              <div className="flex justify-between items-start text-slate-400">
                <span className="text-[11px] font-black uppercase tracking-wider">Total Envíos en Circulación</span>
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex flex-col justify-between">
              <div className="flex justify-between items-start text-slate-400">
                <span className="text-[11px] font-black uppercase tracking-wider">Mensajeros Activos</span>
              ...
              <div className="mt-4">
                ...
                <span className="text-[11px] text-slate-500 font-bold flex items-center gap-1 mt-2">
                  <span className="w-2 h-2 rounded-full bg-emerald-500 inline-block animate-pulse"></span> 94% de uso de capacidad
                </span>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex flex-col justify-between">
              <div className="flex justify-between items-start text-slate-400">
                <span className="text-[11px] font-black uppercase tracking-wider">Incidentes o Retrasos</span>
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex flex-col justify-between">
              <div className="flex justify-between items-start text-slate-400">
                <span className="text-[11px] font-black uppercase tracking-wider">Ganancias del Día</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 bg-blue-50 border border-blue-100 rounded-2xl p-6 relative min-h-[350px] flex flex-col justify-between overflow-hidden">
              <div className="relative z-10 bg-white border border-slate-200 rounded-xl p-3 self-start shadow-sm">
                <h4 className="text-xs font-black text-slate-900 flex items-center gap-1.5">🗺 Red de Distribución en Vivo</h4>
                <p className="text-[10px] text-slate-500 font-medium mt-0.5">Monitoreando 156 repartidores en los 14 departamentos</p>
              </div>
              ...
              <div className="relative z-10 bg-white border border-slate-200 rounded-xl p-3 self-end flex gap-4 text-[10px] font-bold shadow-sm">
                <span className="flex items-center gap-1.5 text-slate-700"><span className="w-2 h-2 rounded-full bg-orange-600"></span> Tránsito Activo</span>
                <span className="flex items-center gap-1.5 text-slate-700"><span className="w-2 h-2 rounded-full bg-blue-900"></span> Central Logística</span>
              </div>
            </div>

            <div className="bg-white border border-slate-200 rounded-2xl p-6 flex flex-col justify-between shadow-sm">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-sm font-black text-slate-900">Envíos en Tiempo Real</h3>
          ...
          {/* ─── SECCIÓN: ADMINISTRADOR DE TARIFAS ─── */}
          <div className="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
            <div className="p-6 border-b border-slate-100 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-slate-50">
              <div>
                <h3 className="text-base font-black text-slate-900">Administrador de Tarifas</h3>
                <p className="text-xs text-slate-500 font-medium mt-0.5">Ajusta multiplicadores de precios según la dificultad operativa de cada zona</p>
              </div>
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="border-b border-slate-100 text-[11px] font-black text-slate-400 uppercase tracking-wider bg-slate-50">
                    ...
                    <th className="py-4 px-6">Dificultad de Zona</th>
                    <th className="py-4 px-6">Multiplicador Base</th>
                    <th className="py-4 px-6">Recargos Activos</th>
                  ...
                  {rates.map((rate) => (
                    <tr key={rate.id} className="hover:bg-slate-50/50 transition-all">
                      ...
                      <td className="py-4 px-6 text-right">
                        <button className="text-blue-600 font-bold hover:text-blue-800 transition-all">Editar</button>
                      </td>
                    </tr>
                  ))}
                </tbody>
            ...
            <div className="p-4 bg-slate-50 border-t border-slate-100 text-center">
              <button className="text-xs font-bold text-blue-900 hover:underline">
                Mostrar los 14 Departamentos completos
              </button>
            </div>
          </div>
        ...
        <footer className="h-14 border-t border-slate-200 px-8 flex flex-col sm:flex-row items-center justify-between gap-2 text-[11px] text-slate-400 font-medium bg-white mt-auto">
          <span>© 2026 Encomiendas SV. Excelencia Logística para El Salvador.</span>
          <div className="flex gap-4">
            <a href="#privacy" className="hover:underline">Política de Privacidad</a>
            <a href="#terms" className="hover:underline">Términos del Servicio</a>
          </div>
        </footer>
      </main>
    </div>
